...
.select-trigger {
  ...
  @apply bg-ui-surface;
  @apply border border-ui-control;
  @apply text-ui-ink;
  @apply transition-all duration-200;
  @apply focus:border-ui-brand focus:outline-none focus:ring-2 focus:ring-ui-brand/30;
  @apply hover:border-ui-brand;
  @apply cursor-pointer;
}

.select-trigger-open {
  @apply border-ui-brand ring-2 ring-ui-brand/30;
}
...
.select-trigger-disabled {
  @apply cursor-not-allowed bg-ui-muted opacity-60;
}
...
.select-icon {
  @apply flex-shrink-0 text-ui-ink-muted;
}
...
.select-dropdown-portal .select-search {
  ...
  @apply border-b border-ui-line;
}

.select-dropdown-portal .select-search-input {
  @apply flex-1 bg-transparent text-sm;
  @apply text-ui-ink;
  @apply placeholder:text-ui-ink-muted;
...
.select-dropdown-portal .select-option {
  ...
  @apply hover:bg-ui-muted;
  pointer-events: auto !important;
}

.select-dropdown-portal .select-option-selected {
  @apply bg-ui-brand-soft;
  @apply text-ui-brand-strong;
}
