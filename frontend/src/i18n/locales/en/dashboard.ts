export default {
  dashboard: {
    ...
    chartsFailed: 'Usage data could not be loaded',
    ...
    infiniteCanvasDesc: 'Draw, video, and chat inside the sidebar',
  ...
  keys: {
    ...
    providerCN: 'Chinese models',
    providerOther: 'Other',
    selectGroup: 'Select a group',
    smartRouting: 'Smart routing',
    smartRoutingHint: 'Add any number of groups in any platform and order them. Groups whose account model catalog does not include the requested model are skipped before selection. Client probes and empty-model requests are not sent to unmatched groups.',
    smartRoutingAdd: 'Add group',
    smartRoutingRoute: 'Route',
    smartRoutingMax: 'No group limit',
    smartRoutingMore: '+{count}',
    smartRoutingChangeInEditor: 'Edit smart-routing keys in the dialog. Changing the group in the table would drop backup groups.',
    smartRoutingEmpty: 'No groups added yet',
    statusLabel: 'Status',
    ...
    ccsImport: {
      title: 'Import to CCS',
      description: 'Choose the platform and model to import. Defaults follow the current group, and you can change them.',
      platform: 'Platform',
      model: 'Model',
      modelPlaceholder: 'e.g. claude-sonnet-4-6',
      modelHint: 'The default follows the platform. The list is loaded from this key’s /v1/models. Changing the platform applies that platform’s default model.',
      modelLoading: 'Loading models with the current API key…',
      claude: 'Claude Code',
      ...
      pi: 'Pi',
      deeplinkUnsupported:
        'CC Switch currently rejects provider deeplinks for this app (Invalid provider app type). Add Pi providers from the Pi page; Claude Desktop provider import is not enabled yet.',
    },
  ...
  modelPlaza: {
    title: 'Model Plaza',
    description: 'Browse available models, base prices and group rates',
    loading: 'Loading...',
    ...
    catalog: {
      ...
      pricingNote: 'Base prices exclude group multipliers. Ranges reflect differences between groups or context tiers. Personal rates, time-based pricing and peak-hour rules may affect the final charge; refer to the group pricing details.',
      ...
      partialPricing: 'Some groups have no configured pricing',
      viewGroups: 'View {count} group rates',
      imageRate: 'Independent image rate',
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      extraEmailsHint: 'The account-bound email can receive alerts by default; extra emails still require verification',
