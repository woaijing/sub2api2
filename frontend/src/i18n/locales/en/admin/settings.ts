export default {
    settings: {
      ...
      payment: {
        ...
        modeQRCode: 'QR Code',
        modePopup: 'Popup',
        instanceRechargeFeeRate: 'Recharge fee rate',
        instanceRechargeFeeRateHint: 'Applies only to this provider. Leave blank to inherit the global payment setting',
        instanceRechargeFeeRatePlaceholder: 'Use global',
        instanceBalanceMultiplier: 'Balance recharge multiplier',
        instanceBalanceMultiplierHint: 'Applies only to this provider. Leave blank to inherit the global payment setting',
        instanceBalanceMultiplierPlaceholder: 'Use global',
