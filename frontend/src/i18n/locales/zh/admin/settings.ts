export default {
    settings: {
      ...
      payment: {
        ...
        modeQRCode: '二维码',
        modePopup: '弹窗',
        instanceRechargeFeeRate: '充值手续费率',
        instanceRechargeFeeRateHint: '仅该服务商生效。留空则跟随支付设置里的全局手续费',
        instanceRechargeFeeRatePlaceholder: '跟随全局',
        instanceBalanceMultiplier: '余额充值倍率',
        instanceBalanceMultiplierHint: '仅该服务商生效。留空则跟随支付设置里的全局倍率',
        instanceBalanceMultiplierPlaceholder: '跟随全局',
