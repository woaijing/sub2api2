<template>
  <div class="relative flex min-h-screen flex-col bg-ui-page text-ui-ink">
...
const ringTrackColor = computed(() => isDark.value ? '#322823' : '#f5f1ec')
...
.input-ring:focus {
  box-shadow: 0 0 0 3px rgb(var(--ui-brand) / 0.2);
...
.skeleton {
  background: linear-gradient(90deg, rgb(var(--ui-line)) 25%, rgb(var(--ui-surface-muted)) 50%, rgb(var(--ui-line)) 75%);
